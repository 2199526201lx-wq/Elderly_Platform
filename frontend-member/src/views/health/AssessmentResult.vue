  ...
  <div class="page">
    ...
    <div v-if="result" style="padding: 12px 16px">
      ...
      <div class="card" style="text-align: center">
        ...
        <p style="font-size: 48px; font-weight: 700; color: #3b9e5a; margin: 8px 0">{{ result.aiScore != null ? result.aiScore : '评分中...' }}</p>
    ...
    <van-loading v-else-if="!loaded" style="display: block; margin: 40px auto" />
    <van-empty v-else description="暂无评测结果" />
  </div>
</template>
...
onMounted(async () => {
  ...
  } catch (e) { /* handled */ } finally { loaded.value = true }
})
</script>
